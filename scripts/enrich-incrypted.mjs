...
const projects=state.projects.filter(p=>p.source.startsWith('https://incrypted.com/airdrops/?single=')&&!['paused','dismissed'].includes(p.workflow)&&(!p.guide||!p.analysisJob));
let done=0,failed=0;
