export function buildAgenda(projects,now=Date.now()) {
  ...
  items.sort((a,b)=>Date.parse(a.dueAt)-Date.parse(b.dueAt)||(a.network==='ink'?0:1)-(b.network==='ink'?0:1)||a.projectName.localeCompare(b.projectName)||a.taskId.localeCompare(b.taskId));
